...
// export class ReadCtx extends Effect.Tag("PersistCtx0")<
//   ReadCtx,
...
//   const gCloudPersistence = yield* PersistCtx;
...
//       return Effect.gen(function* () {
//         const filePath = `projects/${libraryProject.id}.json`;
...
// export const PersistCtx0Live = Layer.effect(ReadCtx, ctxEffect);
