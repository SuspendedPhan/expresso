...
export default class Attribute extends Vue {
  ...
  get picking() {
    return Root.penStore.getIsQuerying() && Root.pen.getSelectedAttribute() === this.attributeModel
  }
  ...
  setText(quill, text) {
    ...
    const annotatedText = Root.pen.getAnnotatedTextForAttribute(this.attributeModel)
  ...
  updateCursor() {
    ...
    if (this.pen.getSelection()?.attributeId === this.attributeModel.id) {
      ...
      this.quill.formatText(selection.startIndex, length, 'background', 'selected', 'silent')
    }
  }
